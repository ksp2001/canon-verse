...
function ArtistInput() {
    ...
    return (
        <div>
            {!loading && apiResponse === '' &&
                <div className="bg-black font-sans text-3xl flex rounded-lg py-24 md:px-24 md:mt-8">
            ...
            {loading && <div className="flex text-center min-h-screen"><div className='m-auto justify-center text-center items-center'><svg width="250" height="250" viewBox="0 0 774 771" fill="none">
            ...
            {apiResponse !== '' && !loading && <div className="flex text-center h-full"><div className="px-4"><GeneratedSong response={apiResponse} /></div></div>}
        </div>
    )
}
